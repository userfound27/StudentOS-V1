 ...
 return <div className="app-shell">
  ...
  <main className="main">
   ...
   <div className="content">
    ...
    {page==="focus"&&<Focus seconds={focusSeconds} minutes={focusMinutes} setMinutes={setFocusMinutes} running={focusRunning} setRunning={setFocusRunning} reset={(minutes)=>{setFocusRunning(false);setFocusSeconds((minutes??focusMinutes)*60)}}/>}
